...
const ProductsCategoria_1 = require("./ProductsCategoria");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => ProductsCategoria_1.ProductCategoria, (productCategoria) => productCategoria.products),
    (0, typeorm_1.JoinColumn)({ name: "productCategoryId" }),
    __metadata("design:type", ProductsCategoria_1.ProductCategoria)
